...
- Check to ensure that your function app's managed identity has Storage Blob Data Contributor, Storage Queue Data Contributor, and Storage Tables Data Contributor role (Check in Azure portal under IAM)
